      ...
      <section class="container py-lg-5">
        ...
        <div class="form-style-5">
          <button type="button" data-toggle="modal" data-target="#Filter-export"
            style="background: #eda200; border:white">Log Filter/ Export to Excel</button>
        </div>


        <!-- Log filter -->
        <div class="modal fade bd-example-modal-lg" id="Filter-export" tabindex="-1" role="dialog"
          aria-labelledby="Filter/Export" aria-hidden="true" style="background: #eda200; border:white">
          <div class="modal-dialog modal-dialog-centered modal-lg animate" role="document"
            style="background: #eda200; border:white">
            <div class="modal-content" style="background: #eda200; border:white">
              ...
              <form method="POST" action="Export_Excel.php" enctype="multipart/form-data">
                <div class="modal-body" style="background-color:#eda200;">
                  <div class="container-fluid" style="background-color:#F2C464;">
                    <div class="row">
                      ...
                      <div class="col-lg-6 col-sm-6">
                        <div class="panel panel-primary">
                          <div class="panel-heading">
                            Filter By:
                            <div class="time">
                              <input type="radio" id="radio-one" name="time_sel" class="time_sel" value="Time_in"
                                checked />
                ...
                <div class="modal-footer" style="background-color:#eda200;">
                  <button type="button" name="user_log" id="user_log" class="btn btn-success"
                    style="background: #eda200; border:white">Filter</button>
                  <button type="button" class="btn btn-secondary" data-dismiss="modal"
                    style="background: #F2C464; border:white">Cancel</button>
                </div>
              </form>
            </div>
          </div>
